...
class TattoosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tattoo" do
    assert_difference('Tattoo.count') do
      post tattoos_url, params: { tattoo: { image_link: @tattoo.image_link, name: @tattoo.name } }
    end
  ...
  test "should update tattoo" do
    patch tattoo_url(@tattoo), params: { tattoo: { image_link: @tattoo.image_link, name: @tattoo.name } }
