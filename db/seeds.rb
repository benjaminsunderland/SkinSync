...
artist6 = Artist.create(name: 'Bob', parlour_id: parlour6.id, rating_id: rate4.id)
artist7 = Artist.create(name: 'Jerry', parlour_id: parlour7.id, rating_id: rate3.id)
artist8 = Artist.create(name: 'Susan', parlour_id: parlour8.id, rating_id: rate1.id)
artist9 = Artist.create(name: 'Beyonce', parlour_id: parlour9.id, rating_id: rate2.id)
artist10 = Artist.create(name: 'Shirley', parlour_id: parlour10.id, rating_id: rate4.id)
